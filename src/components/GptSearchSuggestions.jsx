  ...
  return (
    <div className="m-4">
      ...
      {searchMovies?.map((movie) => {
        console.log(movie);
        return (
          <div className="py-8 my-4 flex-column md:flex justify-center border bg-black opacity-80 rounded-lg">
            <div className="ml-[23%] md:ml-0 md:w-3/12 ">
              <MovieCard key={movie.id} moviesPosterPath={movie.poster_path} />
            </div>
            <div className="ml-2 text-white p-4 md:w-7/12">
              <div className="flex">
              ...
              <p className="my-8  text-sm md:text-md"> {movie.overview}</p>
